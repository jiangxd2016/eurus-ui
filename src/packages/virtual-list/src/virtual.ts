...
interface VirtualParams { slotHeaderSize: number; slotFooterSize: number; keeps: number; estimateSize: number; buffer: number; uniqueIds: any[] }
type callUpdateType = (newRange: any) => void;
export default class Virtual {
  ...
  lastCalcIndex = 0;
  fixedSizeValue = 0;
  calcType: string = CALC_TYPE.INIT;
  offset = 0;
  direction = '';
  range: any = null;
  constructor(param: VirtualParams, callUpdate: callUpdateType ) {
    this.init(param, callUpdate);
  }

  init(param: VirtualParams | null, callUpdate: callUpdateType | null) {
    // param data
    this.param = param;
  ...
  updateParam(key: string, value: any[] | string | number) {

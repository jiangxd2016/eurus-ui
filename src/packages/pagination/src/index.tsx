...
import EInputNumber from '@/packages/input-number';
		...
		return () => (
			<div v-show={!hidePage.value} class={[prefixCls]}>
				...
				{props.pageSizes.length > 0 && (
					<ESelect v-model={state.selectChange} options={selectOptions.value} />
				)}
				<div class="page-list">
					<ul>
						<li>
							<a
								...
								onClick={() => goTo(state.active - 1, state.active === 1)}
							>
								&lt;
							</a>
						</li>

...
import type { MessageConfig, MessageItem, MessagePosition, MessageMethod } from './interface';
import Message from '@/packages/message';
import type { MessageType } from '@/packages/_utils';
import { isFunction, isString, isUndefined, MESSAGE_TYPES } from '@/packages/_utils';

...
describe('EBackTop', () => {
  it('should work with props', async () => {
    ...
    expect(wrapper.find('.eu-back-top').attributes('style')).toMatchInlineSnapshot('"right: 100px; bottom: 200px; visibility: hidden;"');
    ...
    expect(wrapper.find('.eu-back-top').attributes('style')).toMatchInlineSnapshot('"right: 100px; bottom: 200px; visibility: visible;"');
